...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 22 Mai 2018 à 19:18
...
(1, 'F1', '694.00', '90.00', '23 Parc de L\'Industrie', 1, 1, 0, 0, '2008-02-01', 11, 0),
(2, 'F4', '1400.00', '310.00', '14 PL J FERRY', 12, 3, 0, 0, '2007-05-01', 13, 0),
(3, 'F2', '800.00', '150.00', '23 Av St Genest', 14, 10, 1, 0, '2007-07-01', 4, 0),
(4, 'F2', '820.00', '140.00', '104 AV MICHELINNN', 2, 6, 0, 0, '2008-09-30', 6, 0),
...
(10, 'F3', '990.00', '130.00', '56 Champs du Clos', 7, 11, 1, 0, '2010-07-01', 8, 0),
(11, 'STUDIO', '490.00', '45.00', '10 Bv Berthelot', 3, 14, 1, 0, '2008-08-31', 6, 515),
(12, 'F1', '690.00', '90.00', '56 Champs du Clos', 1, 1, 0, 0, '2008-02-01', 1, 0),
(13, 'F3', '1050.00', '135.00', '5 Place de la Mairie', 11, 8, 1, 1, '2007-03-01', 7, 0),
...
(24, 'F5', '1600.00', '220.00', '6 ter place J Jaurès', 5, 6, 1, 0, '2008-07-31', 12, 0),
(25, 'STUDIO', '600.00', '90.00', '69 rue de Jurnieux', 20, 6, 0, 0, '2016-01-21', 4, 0),
(27, 'F4', '7000.00', '1350.00', '14 PL J FERRY', 12, 3, 1, 1, '2007-07-01', 1, 0),
(623, 'F4', '1510.00', '200.00', '104 AV MICHELINNN', 12, 3, 1, 0, '2018-04-02', 9, 514);
...
CREATE TABLE `locataires` (
  ...
  `NOM_LOC` varchar(128) DEFAULT NULL,
  `PRENOM_LOC` varchar(128) DEFAULT NULL,
  `DATENAISS` date DEFAULT NULL,
  `TEL_LOC` char(255) DEFAULT NULL,
  `R_I_B` int(11) DEFAULT NULL,
  `BANQUE` varchar(128) DEFAULT NULL,
  `RUE_BANQUE` varchar(128) DEFAULT NULL,
  `CODEVILLE_BANQUE` varchar(128) DEFAULT NULL,
...
(502, 'ISKRANE', 'Kamel', '1959-03-25', '49 01 06 20', 22236543, 'Kamel ISKRANE', '6 rue des HalleS', 'Paris', '34 69 01 40'),
...
(14, 'ISKRANE', 'Kamel', '17 rue Richard Lenoir', 'Paris', '0601797435');
...
INSERT INTO `visiter` (`NUM_CLI`, `NUMAPPART`, `DATE_VISITE`) VALUES
(107, 17, '2016-02-09'),
(110, 10, '2018-03-06'),
(112, 3, '2018-01-08'),
(114, 11, '2016-02-09'),
...
ALTER TABLE `demandes`
  ...
  ADD KEY `I_FK_DEMANDES_CLIENTS` (`NUM_CLI`) USING BTREE;
...
--
ALTER TABLE `concerner`
  ADD CONSTRAINT `concerner_ibfk_1` FOREIGN KEY (`NUM_DEM`) REFERENCES `demandes` (`NUM_DEM`) ON DELETE CASCADE ON UPDATE CASCADE,
